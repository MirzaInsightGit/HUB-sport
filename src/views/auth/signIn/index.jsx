import React from 'react';
     import { Flex, Heading, Icon, Image, Text, VStack, Button, Box } from '@chakra-ui/react'; // Använder Box
     import { FaMicrosoft } from 'react-icons/fa';
     import { useMsal } from '@azure/msal-react';
     import { loginRequest } from '../../../authConfig'; // Tar bort msalConfig från import
     ...
     const SignIn = () => {
       ...
       return (
         <Box width="100vw" height="100vh"> {/* Använder Box istället för Flex som rot */}
